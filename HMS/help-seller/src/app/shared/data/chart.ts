...
export var chart5: Chart = {
  ...
  data: {
    ...
    series: [
      [164, 362, 252, 416, 293, 362, 263, 387, 345]
    ]
  },
  options: {
    showArea: true,
...
export var chart3: Chart = {
  ...
  data: {
    ...
    series: [
      [285, 495, 343, 547, 726, 524, 624, 536],
      [402, 763, 523, 784, 993, 795, 882, 764]
    ]
  },
  options: {
    height: 303,
...
export var salesChartLabels: Array<any> = ["13-Nov", "14-Nov", "15-Nov", "16-Nov", "17-Nov", "18-Nov"];
